...
modulator.  To do so, run the modulator through a gain node.
	...
	let modulatorGain = new GainNode();
...
`GainNode` to the oscillator.
	...
	let oscillator = new OscillatorNode();
	let oscillatorGain = new GainNode();
