...
Finally, we have created a set of [questions for understanding](todo) at the
end of this module: if you feel comfortable answering each of those questions,
you are ready to move on to the more advanced parts of this course.
...
- sepecific HTML tags and attributes
  ...
  - `<table></table>`, `<thead></thead>`, `<tbody></tbody>`, `<th></th>`, and `<td></td>`
  - `<img />`, plus `src` and `alt` attributes
